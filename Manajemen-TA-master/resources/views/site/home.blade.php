...
@section('content')
<!-- start banner Area -->
			<section class="banner-area relative" id="home" style="background: unset;">
				<div class="overlay overlay-bg"></div>	
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								Selamat datang datang diwebsite SMA 		
							</h1>
							<p class="pt-10 pb-10">
								Selamat datang datang diwebsite SMA 
							</p>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="{{$ps->thumbnail()}}" alt="">								
							</div>
							<p class="meta">{{$ps->created_at->format('d M Y')}} oleh <a href="#">{{$ps->user->name}}</a></p>
							...
							<a href="{{route('site.single.post',$ps->slug)}}" class="details-btn d-flex justify-content-center align-items-center"><span class="details">Details</span><span class="lnr lnr-arrow-right"></span></a>		
						</div>
						@endforeach			
					</div>
				</div>	
